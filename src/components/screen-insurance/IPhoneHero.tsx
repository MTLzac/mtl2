...
export function IPhoneHero() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center relative py-10 w-full" style={{ perspective: "1200px" }}>
      {/* Contact shadow — offset to match tilt */}
      <div className="absolute bottom-2 right-[calc(50%-140px)] w-72 h-10 bg-black/15 blur-[50px] rounded-[100%] pointer-events-none" />

      {/* CHASSIS with perspective tilt */}
      <motion.div
        animate={{
          y: [0, -10, 0],
          rotateY: [-4, -4, -4],
