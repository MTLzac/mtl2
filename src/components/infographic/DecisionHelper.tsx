...
export const DecisionHelper = () => {
  ...
  const getRecommendation = (): Recommendation => {
    // Decision logic (transparent and documented):
    // IF device_age < 2 years AND powers_on = yes → "Repair often makes sense"
    // IF device_age >= 2 AND device_age < 4 AND issue = screen|battery|backglass → "Repair may make sense"
    // IF device_age >= 4 OR powers_on = no → "Data recovery and trade-in may be smarter"
  ...
  return (
    <section className="py-12 md:py-16 bg-muted/30" aria-labelledby="decision-helper">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="bg-background rounded-lg border border-border p-6 md:p-8 space-y-8">
        ...
        {/* Decision Logic Documentation (visible in DOM for AI readability) */}
