...
/**
 * Mobile-only sticky CTA bar driving users to the quote widget.
 * Hides automatically when the user scrolls into the final
 * "Book Your iPhone Repair" CTA section so it doesn't compete.
 */
export const IPhoneStickyQuoteBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-primary/40 bg-primary px-4 py-3 shadow-lg md:hidden">
      ...
      >
        Get Your iPhone Quote — Reply in 1-2 hours
