...
const iPhone11ProData: DeviceHubData = {
  ...
  metaDescription:
    "A factual guide to the iPhone 11 Pro in 2026 — covering iOS support, OLED repair costs, battery life, app compatibility, and trade-in or upgrade options for Canadian users.",
  ...
  featuredSnippetHtml: `
    <p>As of early 2026, the iPhone 11 Pro remains in Apple's active software support window, based on Apple's current support cycle. Released in 2019 as Apple's premium compact flagship, the 11 Pro features a 5.8-inch Super Retina XDR OLED display, the A13 Bionic chip, and Apple's first triple-camera system. Unlike the <a href="/devices/iphone-11">standard iPhone 11</a> with its LCD panel, the 11 Pro's OLED screen carries significantly higher repair costs — a critical factor when evaluating whether to fix, sell, or upgrade.</p>
  ...
  `,
  tldrHtml: `
    <p><strong>TL;DR:</strong> As of early 2026, the iPhone 11 Pro still receives iOS updates and remains a capable daily driver. Battery and single-component repairs are cost-effective, but OLED screen replacement costs significantly more than the LCD in the <a href="/devices/iphone-11">standard iPhone 11</a> — making multi-repair scenarios harder to justify financially.</p>
  `,
  ...
  viabilityScores: [
    {
      ...
      score: 3,
      explanation:
        "The iPhone 11 Pro ships with a 3,046 mAh battery — slightly smaller than the standard iPhone 11's 3,110 mAh cell. By 2026, most original batteries have degraded meaningfully, resulting in noticeably shorter screen-on time and more frequent charging cycles. Battery replacement remains the most cost-effective repair for this model and fully restores daily endurance.",
    },
    {
      label: "Repair Cost (Relative)",
      score: 3.5,
      explanation:
        "The 11 Pro uses a Super Retina XDR OLED display, which costs significantly more to replace than the LCD panel in the <a href='/devices/iphone-11'>standard iPhone 11</a>. Single-issue repairs (battery, charging port) remain proportionate to the device's value, but the OLED premium means multi-repair scenarios — especially involving the screen — can approach or exceed the phone's current market value.",
    },
    {
    ...
    },
    {
      ...
      score: 3,
      explanation:
        "As of early 2026, the iPhone 11 Pro remains in Apple's active update window based on the current support cycle. Like the standard iPhone 11, the A13 Bionic is likely approaching the end of its major update lifecycle within the next one to two years, based on Apple's historical support patterns.",
    },
  ],
  quickTakeawayHtml: `
    <strong>Quick takeaway:</strong> The iPhone 11 Pro remains a capable premium device in early 2026 with active iOS support and a strong triple-camera system. However, its OLED display makes screen repairs meaningfully costlier than the <a href="/devices/iphone-11">LCD-equipped iPhone 11</a>. For battery-only or single-issue repairs, the 11 Pro is generally worth fixing. For multiple major repairs — especially involving the OLED screen — the higher cost shifts the calculus toward <a href="/trade-in">trading in</a> and upgrading.
  `,
  ...
  iosSupportStatus: {
    ...
    contentHtml: `
      <p>The iPhone 11 Pro shipped with iOS 13 and, as of early 2026, continues to receive major updates based on Apple's current support cycle. It shares the same A13 Bionic chip as the <a href="/devices/iphone-11">standard iPhone 11</a>, which means both devices follow the same software support timeline.</p>
      <p>The A13 Bionic provides sufficient performance for current iOS features, though some processor-intensive features introduced in newer iOS versions may be unavailable or limited on this hardware.</p>
    ...
    whatVersion: {
      ...
      contentHtml: `
        <p>As of early 2026, the iPhone 11 Pro supports <strong>iOS 18</strong> based on Apple's current support cycle. This provides full access to current app frameworks, security updates, and new features.</p>
  ...
  updateDeprecation: {
    ...
    contentHtml: `
      <p>The iPhone 11 Pro still receives iOS updates as of early 2026, but based on Apple's historical patterns, it is approaching the end of its major update lifecycle. When updates do stop, the device continues to function — calls, messaging, browsing, and installed apps work normally.</p>
    ...
    appCompatibility: {
      ...
      contentHtml: `
        <p>Because the iPhone 11 Pro currently runs a supported version of iOS, Canadian users have <strong>full app compatibility</strong> today:</p>
        <ul>
        ...
        <p>This gives the 11 Pro a significant advantage over the <a href="/devices/iphone-xs">iPhone XS</a> and <a href="/devices/iphone-xr">iPhone XR</a> generation, where some of these apps are beginning to show compatibility warnings.</p>
      `,
    },
  },
    ...
    whenUpgradeIsBetter: {
      ...
      contentHtml: `
        <ul>
          ...
          <li><strong>Face ID failure after drops</strong> — TrueDepth camera system repairs on the 11 Pro can be complex and costly, similar to the <a href="/devices/iphone-xs">XS generation</a>.</li>
          <li><strong>Multiple simultaneous repairs</strong> — When screen, battery, and back glass all need attention, the combined cost — driven primarily by the OLED panel — often favours <a href="/trade-in">trading in</a> and upgrading.</li>
          <li><strong>Desire for 5G or MagSafe</strong> — Like the <a href="/devices/iphone-11">standard iPhone 11</a>, the 11 Pro does not support 5G or MagSafe. If these features matter, upgrading to an iPhone 12 or later is the path forward.</li>
        </ul>
      `,
    },
  },
  ...
  commonDamage: {
    ...
    frontGlass: {
      ...
      contentHtml: `
        <p>The iPhone 11 Pro uses a 5.8-inch Super Retina XDR OLED display — Apple's most advanced screen technology at the time of release. When the screen cracks, the entire OLED panel and digitizer assembly must be replaced as a single unit, making it significantly more expensive than the <a href="/devices/iphone-11">LCD replacement on the standard iPhone 11</a>.</p>
  ...
  tradeInUpgrade: {
    ...
    contentHtml: `
      <p>The iPhone 11 Pro holds moderate trade-in value in early 2026. Its ongoing iOS support, stainless steel build, and triple-camera system help it retain value better than the <a href="/devices/iphone-11">standard iPhone 11</a> or the older <a href="/devices/iphone-xs">XS models</a>.</p>
      <p>However, because the 11 Pro was a premium device at launch, users often have higher expectations for camera quality and performance — areas where newer Pro models offer significant improvements. The triple camera still produces excellent photos in good lighting, but computational photography and low-light performance in iPhone 13 Pro and later models represent a meaningful leap.</p>
  ...
  decisionGuide: {
    ...
    contentHtml: `
      <p>The iPhone 11 Pro's repair decision is more nuanced than the <a href="/devices/iphone-11">standard iPhone 11</a> because of the OLED cost factor. Here's a practical framework:</p>
    `,
    scenarios: [
      {
        condition: "Battery wear or single minor issue",
        recommendation:
          "Repair is typically the right call. Battery replacement is cost-effective, and the device still receives iOS updates as of early 2026. For a single failing component — battery, charging port, or camera — repair extends a phone that remains competitive with current software and a strong camera system.",
      },
      {
        condition: "OLED screen damage (single issue)",
        recommendation:
          "Repair is usually worthwhile, but compare costs carefully. OLED replacement on the 11 Pro costs significantly more than LCD replacement on the standard iPhone 11. If the rest of the device is in good condition and battery health is acceptable, screen-only repair still delivers good value given the device's ongoing iOS support.",
      },
      {
  ...
  faqs: [
    {
      ...
      answerHtml:
        "As of early 2026, the iPhone 11 Pro still receives major iOS updates. Based on Apple's historical pattern of six to seven years of support, the A13 Bionic is likely in its final one to two years of major releases before transitioning to security-only updates. Source: <a href='https://support.apple.com/en-ca/guide/iphone/iphe3fa5df43/ios' target='_blank' rel='noopener noreferrer'>Apple</a>.",
    },
    {
      question: "Is the iPhone 11 Pro worth fixing?",
      answerHtml:
        "For battery or single-component repairs, yes — the device still receives iOS updates and its triple-camera system remains strong. However, the OLED display costs significantly more to replace than the LCD in the <a href='/devices/iphone-11'>standard iPhone 11</a>. If multiple major repairs are needed, upgrading is usually more practical. See our <a href='/repair/iphone'>iPhone repair page</a> for details.",
    },
    {
      question: "Can I still use an iPhone 11 Pro in 2026?",
      answerHtml:
        "Yes. As of early 2026, the iPhone 11 Pro runs a current version of iOS, has full app compatibility, and its triple-camera system still produces excellent photos. The main limitations compared to newer Pro models are the lack of 5G, MagSafe, ProMotion 120Hz display, and newer computational photography features.",
    },
    {
      question: "What is the resale value of an iPhone 11 Pro?",
      answerHtml:
        "The 11 Pro generally holds higher trade-in value than the <a href='/devices/iphone-11'>standard iPhone 11</a> due to its OLED display, stainless steel build, and triple camera. Value depends on condition, battery health, and storage capacity. For a current estimate, see our <a href='/trade-in'>trade-in page</a>.",
    },
    {
      question: "What's the difference between the iPhone 11 and iPhone 11 Pro?",
      answerHtml:
        "Both share the A13 Bionic chip and the same iOS support timeline. Key differences: the 11 Pro uses a 5.8-inch OLED display (vs. 6.1-inch LCD), has a triple-camera system (vs. dual), features a stainless steel frame (vs. aluminium), and has a smaller 3,046 mAh battery. For repair purposes, the OLED screen is the most significant difference — it costs meaningfully more to replace than the <a href='/devices/iphone-11'>iPhone 11's LCD</a>.",
    },
  ],
};
