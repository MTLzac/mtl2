...
const faqs: FAQ[] = [
  {
    ...
    answer: "We begin work as soon as your device arrives. If parts are in stock, repairs are usually completed the same day. Shipping to and from Selkirk typically takes 1–2 business days."
  },
  {
...
const selkirkReviews = [
  {
    name: "Sarah M.",
    rating: 5,
    text: "Sent my iPhone in from Selkirk and had it back within 3 days. Screen looks brand new and the price was fair. Highly recommend!"
  },
  {
    name: "Mike Thompson",
    rating: 5,
...
const breadcrumbs = [
  ...
  { name: "Selkirk, MB", url: "https://mobiletechlab.ca/service-area/selkirk" }
];

const SelkirkServiceArea = () => {
  return (
    <>
      <Helmet>
        <title>Mail-In Phone & Device Repair for Selkirk, MB | Mobile Tech Lab</title>
        <meta 
          name="description" 
          content="Selkirk, MB mail-in phone and device repair. Free prepaid shipping, fast turnaround, trusted service. Get a free quote for iPhone, Samsung, Nintendo Switch repairs and more." 
        />
        <link rel="canonical" href="https://mobiletechlab.ca/service-area/selkirk" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Professional phone, tablet, laptop & console repair for Selkirk, Manitoba. Free mail-in service with fast turnaround.",
      ...
      <main className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="text-lg text-muted-foreground">
                ...
                Samsung screen replacements, and more through a simple, hassle-free mail-in process.
              </p>
            </div>
          </div>
        </section>
        ...
        <MailInHowItWorks cityName="Selkirk" />
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <p className="text-center text-muted-foreground">
                ...
                <Link to="/repair/nintendo-switch" className="text-primary hover:underline">
                  Nintendo Switch Joy-Con fixes
                </Link>
                . Whether you need a{" "}
                <Link to="/repair/ipad" className="text-primary hover:underline">
                  cracked iPad screen replaced
                </Link>{" "}
                or{" "}
                <Link to="/repair/macbook" className="text-primary hover:underline">
                  MacBook keyboard repair
                </Link>
                , if you're in Selkirk or the surrounding Interlake area, you can trust us with your mail-in phone repair.
              </p>
            </div>
          </div>
        </section>
        ...
        <FAQSection 
          ...
          subheading="Common questions about mail-in repairs for Selkirk customers"
        />
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="mb-3 text-2xl font-bold md:text-3xl">
                Ready to Get Your Device Fixed from Selkirk?
              </h2>
              <p className="mb-6 text-muted-foreground">
...
export default SelkirkServiceArea;
