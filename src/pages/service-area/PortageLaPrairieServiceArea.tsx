...
const faqs: FAQ[] = [
  {
    ...
    answer: "We begin work as soon as your device arrives. If parts are in stock, repairs are usually completed the same day. Shipping to and from Portage la Prairie typically takes 1–2 business days."
  },
  {
...
const breadcrumbs = [
  ...
  { name: "Portage la Prairie", url: "https://mobiletechlab.ca/service-area/portage-la-prairie" }
];

const PortageLaPrairieServiceArea = () => {
  return (
    <>
      <Helmet>
        <title>Mail-In Phone & Device Repair for Portage la Prairie | Mobile Tech Lab</title>
        <meta 
          name="description" 
          content="Portage la Prairie mail-in phone and device repair. Free prepaid shipping, fast turnaround, trusted service. Get a free quote for iPhone, Nintendo Switch, PS5 repairs and more." 
        />
        <link rel="canonical" href="https://mobiletechlab.ca/service-area/portage-la-prairie" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Professional phone, tablet, laptop & console repair for Portage la Prairie, Manitoba. Free mail-in service with fast turnaround.",
      ...
      <main className="min-h-screen bg-background">
        ...
        <MailInHowItWorks cityName="Portage la Prairie" />

        {/* Get Started CTA */}
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="mb-3 text-2xl font-bold md:text-3xl">Start Your Repair Now</h2>
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <p className="text-center text-muted-foreground">
                ...
                <Link to="/repair/iphone" className="text-primary hover:underline">
                  iPhone repair in Portage la Prairie
                </Link>
                , a{" "}
                ...
                —we've got you covered. Our certified technicians handle repairs for smartphones, 
                tablets, laptops, and gaming consoles with fast turnaround and quality parts.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="mb-8 text-center">
              <h2 className="mb-2 text-2xl font-bold md:text-3xl">
                Trusted Across Manitoba
              </h2>
              <p className="text-muted-foreground">
                We've helped thousands of customers throughout Manitoba get reliable repairs by mail—including customers in Portage la Prairie.
              </p>
            </div>
        ...
        {/* FAQ Section */}
        <FAQSection 
          deviceName="Portage la Prairie"
          faqs={faqs}
          heading="Frequently Asked Questions"
          subheading="Common questions about mail-in repairs for Portage la Prairie customers"
        />
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="mb-3 text-2xl font-bold md:text-3xl">
                Ready to Get Your Device Fixed from Portage la Prairie?
              </h2>
              <p className="mb-6 text-muted-foreground">
...
export default PortageLaPrairieServiceArea;
