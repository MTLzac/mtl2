...
const ADVANTAGE_PILLARS = [
  ...
  },
  {
    ...
    description: "All Galaxy Tab repairs backed by our comprehensive warranty.",
  },
];
...
const SamsungGalaxyTabRepair = () => {
  return (
    <RepairLandingTemplate
      ...
      metaDescription="Professional Samsung Galaxy Tab repair in Winnipeg. Screen replacement, battery, charging port repair for Tab S10, S9, S8, A9, Active & all models. Same-day service."
      deviceName="Samsung Galaxy Tab"
      tagline="Samsung Galaxy Tab Repair in Winnipeg"
