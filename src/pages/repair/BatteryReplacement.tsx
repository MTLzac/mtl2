              ...
              <div className="mx-auto max-w-4xl space-y-6">
                ...
                <div className="space-y-4 text-lg text-muted-foreground">
                  <p>
                    ...
                    <strong className="text-foreground">Apple Independent Repair Provider</strong>, we offer Genuine Apple
                    batteries for iPhone repair — at the same price as Apple's official service. Free battery health
                    check on the spot — we'll tell you honestly whether you need a new battery or if there's another
                    issue. <strong className="text-foreground">90-day warranty.</strong> Walk in to our St. Vital or
                    Thompson location, or get a quote online.
                  </p>
                </div>
